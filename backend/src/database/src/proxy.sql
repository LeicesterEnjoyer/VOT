INSERT INTO mysql_servers (hostgroup_id, hostname, port, max_connections) VALUES (0, 'mysql-master', 3306, 1000);
INSERT INTO mysql_servers (hostgroup_id, hostname, port, max_connections) VALUES (1, 'mysql-slave', 3306, 1000);
